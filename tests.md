...
| :--- | :--- | :--- | :--- | :--- |
| **Packet Encoding** | `type=1`, `seqNum=100`, `data="Test"` passed to `Packet` constructor. Then calling `encode()`. | Encoded string matching format (e.g., `"1|100|Test"`) | Successfully encoded string `"1|100|Test"` | **Pass** |
| **Packet Decoding** | Calling `decode("2|50|Status")` | Packet sets `packetType=2`, `seqNum=50`, `payload="Status"` | Object internal variables match expected values | **Pass** |
